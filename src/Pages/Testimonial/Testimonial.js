    ...
    return (
        <section>
            <div className='flex justify-between'>
                <div>
                    <h4 className='text-2xt text-primary font-bold'>Testimonial</h4>
                    <h2 className="text-4xl text-bold">What Our Patients Says</h2>
                </div>
                <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                {
                    testimonials.map((testimonial) => <Review key={testimonial._id}
